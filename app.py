...
def gerar_pdf_membros(membros: list) -> bytes:
    ...
    header_style = ParagraphStyle("header", fontName="Helvetica-Bold", fontSize=10, textColor=WHITE, alignment=TA_CENTER)
    name_style   = ParagraphStyle("name",   fontName="Helvetica-Bold", fontSize=11, textColor=BLACK, alignment=TA_LEFT, leading=14)
    label_style  = ParagraphStyle("label",  fontName="Helvetica",      fontSize=9,  textColor=GRAY,  alignment=TA_LEFT)
    code_style   = ParagraphStyle("code",   fontName="Helvetica-Bold", fontSize=13, textColor=NAVY,  alignment=TA_CENTER)
    buf_pdf = io.BytesIO()
    ...
    for m in membros:
        ...
        info = [
            Paragraph(m["nome"], name_style), Spacer(1, 4),
        ...
        card = Table([[Paragraph("CHECK-IN QR CODE — MUSICAL CCB", header_style), ""], [rl_img, info], [Paragraph(m["id"], code_style), ""]], colWidths=[4*cm, 12*cm])
        card.setStyle(TableStyle([
            ("BACKGROUND",    (0,0), (-1,0), NAVY), ("SPAN", (0,0), (-1,0)),
            ("TOPPADDING",    (0,0), (-1,0), 6),    ("BOTTOMPADDING", (0,0), (-1,0), 6),
            ("VALIGN",        (0,1), (-1,1), "MIDDLE"), ("ALIGN", (0,1), (0,1), "CENTER"),
            ("LEFTPADDING",   (1,1), (1,1),  10),   ("TOPPADDING",    (0,1), (-1,1), 8),
            ("BOTTOMPADDING", (0,1), (-1,1), 8),    ("SPAN",          (0,2), (-1,2)),
            ("BACKGROUND",    (0,2), (-1,2), LIGHT),("TOPPADDING",    (0,2), (-1,2), 6),
            ("BOTTOMPADDING", (0,2), (-1,2), 6),    ("BOX",           (0,0), (-1,-1), 1, NAVY),
        ]))
        story.append(card)
...
# ===================================================
    ...
    INSTRUMENTOS = [
        "CLARINETE","FLAUTA","ÓRGÃO","SAXOFONE ALTO","SAXOFONE TENOR",
